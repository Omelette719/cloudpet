<div>
    ...
    <div class="cp-card" style="margin-bottom: 1.5rem; display: flex; flex-direction: column; gap: 1rem;">
        <div style="display: flex; justify-content: space-between; align-items: flex-start; flex-wrap: wrap; gap: 1rem;">
            ...
            {{-- Aksi Kanan (Upload & Hapus Bucket) --}}
            <div style="display: flex; align-items: center; gap: 0.8rem;">
                
                {{-- ✅ PERBAIKAN: Kirim prefix dan berikan Key Dinamis agar path upload selalu terupdate --}}
    ...
    {{-- ... (Sisa kode untuk Flash Message dan File Explorer dibiarkan sama seperti sebelumnya) ... --}}
                ...
                @foreach($folders as $folder)
                    <tr style="transition: background-color 0.2s;" onmouseover="this.style.backgroundColor='#f0f4ec'" onmouseout="this.style.backgroundColor='transparent'">
                        ...
                        <td style="text-align: right;">
                            {{-- ✅ TOMBOL HAPUS FOLDER DITAMBAHKAN DI SINI --}}
